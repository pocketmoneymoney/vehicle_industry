...
module.exports = {
  ...
  entry: {
	  ...
	  buyer_purchase_buy_record: './src/buyer/purchase_buy_record.js',
	  buyer_activity_record: './src/buyer/activity_record.js',
	  buyer_position_record: './src/buyer/position_record.js',
	  ...
	  supplier_purchase_buy_record: './src/supplier/purchase_buy_record.js',
	  supplier_activity_record: './src/supplier/activity_record.js',
	  supplier_position_record: './src/supplier/position_record.js',
