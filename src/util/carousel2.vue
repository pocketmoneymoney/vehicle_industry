...
.slides-thumbnail .bx-prev { width: 32px; height: 72px; background-image: url(http://cdn.huodongxing.com/Content/v2.0/dist/css/sprite/index_login_bg.32.png); background-position: -76px 0; }
.slides-thumbnail .bx-prev:hover { background-image: url(http://cdn.huodongxing.com/Content/v2.0/dist/css/sprite/index_login_bg.32.png);  background-position: -114px 0;  }
.slides-thumbnail .bx-next { width:32px;  height:72px;background-image:url(http://cdn.huodongxing.com/Content/v2.0/dist/css/sprite/index_login_bg.32.png); background-position:0 0;}
.slides-thumbnail .bx-next:hover{background-image: url(http://cdn.huodongxing.com/Content/v2.0/dist/css/sprite/index_login_bg.32.png); background-position: -38px 0; }
