...
.project_enroll span.long{ position:absolute; width:30px; height:30px; background:url(../images/pic/long.png) no-repeat; right:0em; top:0px; background-size:2em;padding-left:0px;}
*/
</style>
